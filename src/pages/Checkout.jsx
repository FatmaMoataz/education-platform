      ...
      >
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4 text-center">
          ...
          <p className="text-gray-600 mb-6">
            You've successfully enrolled in "{course.title}". You can now access all course content.
          </p>
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Secure checkout with 30-day money-back guarantee</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-6 p-4 bg-success-50 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-success-800 font-medium">30-day money-back guarantee</span>
              </div>
            </div>
          </div>
