...
function Register() {
  ...
  const { loadingAuth, authMessage, error } = useSelector((state) => state.auth);
...
useEffect(() => {
  ...
  transition={{ duration: 0.6 }} className="min-h-screen md:flex-row flex items-center justify-center sm:flex-col">
        <div className="bg-white">
        <img src={authImg} alt="" />
      </div>
      <div className="bg-white p-8 w-full">
        <h2 className="text-4xl font-bold mb-6 text-center text-blue-600">Create an Account</h2>
          ...
          {() => (
            <Form className="space-y-4">
              <div>
                ...
                <Field name="fullName" className="mt-1 p-2 w-full border rounded" />
              ...
              <div>
                ...
                <Field name="phoneNumber" className="mt-1 p-2 w-full border rounded" />
              ...
              <div>
                ...
                <Field name="cpassword" type="password" className="mt-1 p-2 w-full border rounded" />
              ...
              <div>
                ...
                <Field name="classLevel" as="select" className="mt-1 p-2 w-full border rounded">
                ...
                <ErrorMessage name="classLevel" component="div" className="text-red-500 text-sm" />
              </div>
              ...
              <h3 className="text-center ">Already a user? <span onClick={() => navigate('/login')} className="text-blue-600 cursor-pointer">
  Log in
</span>
</h3>
            </Form>
